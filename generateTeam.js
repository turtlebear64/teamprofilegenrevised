...
let generateEngineerCard = (Engineers) => {
  return `
  <div class="card m-1 shadow" style="width: 18rem">
    <div class='card-header'>
      <h3 class="card-title">${Engineers.getName()}</h3>
      <h6 class="card-text"><i class="fa fa-laptop"></i> ${Engineers.getRole()}</h6>
    </div>
    <div class="card-body">
      <ul class="list-group list-group-flush">
        <li class="list-group-item">ID: ${Engineers.getId()}</li>
        <li class="list-group-item">Email: ${Engineers.getEmail()}</li>
        <li class="list-group-item">GitHub: ${Engineers.getGithub()}</li>
      </ul>
    </div>
  </div>
  `
...
let generateManagerCard = (Managers) => {
  return `
  <div class="card m-1 shadow" style="width: 18rem">
    <div class='card-header'>
      <h3 class="card-title">${Managers.getName()}</h3>
      <h6 class="card-text"><i class="fa fa-coffee"></i> ${Managers.getRole()}</h6>
    </div>
    <div class="card-body">
      <ul class="list-group list-group-flush">
...
let generateInternCard = (Interns) => {
  return `
  <div class="card m-1 shadow" style="width: 18rem">
    <div class='card-header'>
      <h3 class="card-title">${Interns.getName()}</h3>
      <h6 class="card-text"><i class="fa fa-graduation-cap"></i> ${Interns.getRole()}</h6>
    </div>
    <div class="card-body">
      <ul class="list-group list-group-flush">
        <li class="list-group-item">ID: ${Interns.getId()}</li>
        <li class="list-group-item">Email: ${Interns.getEmail()}</li>
